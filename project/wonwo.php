...
<table>
  ...
  <td><b>Age</b> </td>
  <td> : <input type="number" maxlength="2" name="age"></td>
  </tr>
  <tr>
  <td> <b>Complaints about your disease &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </b> : </td>
  <td>  <textarea rows="" name="complaints" cols="40"></textarea></td>
  </tr>
<tr>
  <td><a href="Receipt.php"> <input type="submit" value="Submit" name="save" onclick="alert('You Have Made An appointment with dr.Wonwoo Jeon :) ')" > </input> </a>
  ...
  <?php
    ...
    if(isset($_POST['save'])){
      ...
      $insert = mysqli_query($conn, "INSERT INTO doctorwonwo VALUES(NULL, '$appointmentdate', '$name', '$gender', '$age', '$complaints')");
    }
